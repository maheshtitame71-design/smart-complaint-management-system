          ...
          <div className="mx-auto max-w-5xl">
            ...
            <div className="mb-6 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="mb-6">
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Choose which complaint updates you
                  want to receive
                </p>
              ...
              <div className="space-y-5">
                ...
                <div className="flex items-center justify-between border-b border-slate-100 pb-5">
                  ...
                  <div className="pr-5">
                    ...
                    <p className="mt-1 text-xs text-slate-400">
                      Notify me when my complaint is
                      assigned to staff
                    </p>
                  ...
                  <button
                    ...
                    aria-label="Toggle complaint assigned notifications"
                    className={`relative h-6 w-11 shrink-0 rounded-full transition ${
                      notificationSettings.assigned
                        ? "bg-blue-600"
                        : "bg-slate-300"
                    }`}
                  >
                ...
                <div className="flex items-center justify-between border-b border-slate-100 pb-5">
                  ...
                  <div className="pr-5">
                    ...
                    <p className="mt-1 text-xs text-slate-400">
                      Notify me when staff starts working
                      on my complaint
                    </p>
                  ...
                  <button
                    ...
                    aria-label="Toggle work started notifications"
                    className={`relative h-6 w-11 shrink-0 rounded-full transition ${
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    aria-label="Toggle resolved notifications"
                    className={`relative h-6 w-11 shrink-0 rounded-full transition ${
