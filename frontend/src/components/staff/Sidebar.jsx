...
const navigation = [
  ...
  { label: 'Assigned Complaints', path: '/staff/assigned-complaints', icon: '▣' },
  { label: 'My Profile', path: '/staff/profile', icon: '◔' },
  {label: "Settings", path: "/staff/settings", icon: "⚙️",
}
];
    ...
    <aside className="hidden w-72 shrink-0 border-r border-slate-200 bg-slate-950 text-slate-200 lg:flex lg:flex-col">
      <div className="flex items-center gap-3 border-b border-slate-800 px-6 py-6">
        ...
        <div>
          ...
          <p className="text-xs uppercase tracking-[0.2em] text-slate-400">Staff Portal</p>
        </div>
      </div>
